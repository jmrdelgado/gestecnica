    ...
    <div class="row">
    	...
    	<form class="form-acciones needs-validation was-validated" method="post" action="../../logic/alta_new_accion.php" name="alta_acciones">
    		<div class="mb-3">
                ...
                <input type="text" class="form-control col-4" id="nif_tutor" name="nif_tutor" placeholder="" maxlength="9" required>
            </div>
			...
			<div class="mb-3">
                ...
                <input type="email" class="form-control col-4" id="email_tutor" name="email_tutor" placeholder="" >
            </div>
